...
const BookSingleCard = ({ book }) => {
  ...
  return (
    <div className="border-2 border-gray-500 px-4 py-2 m-4 rounded-lg relative hover:shadow-xl">
      <h2 className="bg-red-300 rounded-lg absolute top-1 right-2 px-4 py-1">
        {book.publishYear}
      </h2>
      ...
      <div className="flex justify-between items-center mt-4 gap-x-2 p-4">
        <BiShow
